...
type Props = {
	...
	selected: (typeof PROJECT_LIST)[0] | null;
};

export default function ProjectList({ onSelect, selected }: Props) {
	return (
		<div className="max-h-[410px] pr-1">
				...
				return (
					<div
						...
						className={`my-2 rounded-[4px] border border-gray-200 shadow-sm p-1.5 
							...
							hover:shadow-md hover:bg-gray-50 hover:scale-[1.01] cursor-pointer ${isSelected ? 'bg-red-50 border-red-200' : ''
							}`}
					>
